...
public class Bridge implements IPostMessage {
    ...
    private void loadWebView() {
        ...
        GeckoSessionSettings sessionSettings = new GeckoSessionSettings.Builder()
                ...
                .userAgentOverride("geckoview_accessing_localhost_port/" + config.getPort() + ";" + overriddenUserAgentString + appendedUserAgentString)
                .build();
...
//      @Edward: Somehow scheme is wrong (HTTPS instead of HTTP), manually set it.
//        localUrl = scheme + "://" + authority;
        localUrl = "http://" + authority;
...
//            String localUrl = scheme + "://" + authority;
            String localUrl = "http://" + authority;
